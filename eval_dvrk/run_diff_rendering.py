...
def parseArgs(): 
    ...
    parser.add_argument('-rf', '--ref_img_file', type=str, required=False, default='data/extra_set/00203.jpg',
...
if __name__ == '__main__': 
    ...
    axis_angle = th.tensor([9.9789e-01, -1.0730e+00, -2.6353e-01])
    xyz = th.tensor([-9.3132e-10, -0.0000e+00,
          1.5000e-01])
