...
from pytorch3d.renderer import (
    ...
    PerspectiveCameras, FoVPerspectiveCameras,Textures, look_at_view_transform
)
...
class RobotMeshRenderer():
    ...
    """
    def __init__(self, focal_length, principal_point, image_size, robot, mesh_files, device, visibility_flags):
